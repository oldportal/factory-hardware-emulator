...
${OBJECTDIR}/factory-hardware-emulator/EmulatorApplication.o: factory-hardware-emulator/EmulatorApplication.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/EmulatorApplication.o factory-hardware-emulator/EmulatorApplication.cpp
...
${OBJECTDIR}/factory-hardware-emulator/_group_factory-hardware-emulator.o: factory-hardware-emulator/_group_factory-hardware-emulator.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/_group_factory-hardware-emulator.o factory-hardware-emulator/_group_factory-hardware-emulator.cpp
...
${OBJECTDIR}/factory-hardware-emulator/device/Device.o: factory-hardware-emulator/device/Device.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/device/Device.o factory-hardware-emulator/device/Device.cpp

${OBJECTDIR}/factory-hardware-emulator/device/_group_device.o: factory-hardware-emulator/device/_group_device.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/device
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/device/_group_device.o factory-hardware-emulator/device/_group_device.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/HardwareDevice.o: factory-hardware-emulator/hardware/HardwareDevice.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/HardwareDevice.o factory-hardware-emulator/hardware/HardwareDevice.cpp

${OBJECTDIR}/factory-hardware-emulator/hardware/_group_hardware.o: factory-hardware-emulator/hardware/_group_hardware.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/hardware
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/_group_hardware.o factory-hardware-emulator/hardware/_group_hardware.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics/Motor.o: factory-hardware-emulator/hardware/mechatronics/Motor.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics/Motor.o factory-hardware-emulator/hardware/mechatronics/Motor.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics/MotorModbus.o: factory-hardware-emulator/hardware/mechatronics/MotorModbus.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics/MotorModbus.o factory-hardware-emulator/hardware/mechatronics/MotorModbus.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics/MotorSettings.o: factory-hardware-emulator/hardware/mechatronics/MotorSettings.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics/MotorSettings.o factory-hardware-emulator/hardware/mechatronics/MotorSettings.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics/StepMotor.o: factory-hardware-emulator/hardware/mechatronics/StepMotor.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics/StepMotor.o factory-hardware-emulator/hardware/mechatronics/StepMotor.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics/_group_mechatronics.o: factory-hardware-emulator/hardware/mechatronics/_group_mechatronics.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/mechatronics/_group_mechatronics.o factory-hardware-emulator/hardware/mechatronics/_group_mechatronics.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/ControllerData.o: factory-hardware-emulator/hardware/modbus/ControllerData.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/ControllerData.o factory-hardware-emulator/hardware/modbus/ControllerData.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/InterfaceSettings.o: factory-hardware-emulator/hardware/modbus/InterfaceSettings.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/InterfaceSettings.o factory-hardware-emulator/hardware/modbus/InterfaceSettings.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/ModbusRegistersMapping.o: factory-hardware-emulator/hardware/modbus/ModbusRegistersMapping.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/ModbusRegistersMapping.o factory-hardware-emulator/hardware/modbus/ModbusRegistersMapping.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/StepMotorDriverCalculationConstants.o: factory-hardware-emulator/hardware/modbus/StepMotorDriverCalculationConstants.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/StepMotorDriverCalculationConstants.o factory-hardware-emulator/hardware/modbus/StepMotorDriverCalculationConstants.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/StepMotorDriverData.o: factory-hardware-emulator/hardware/modbus/StepMotorDriverData.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/StepMotorDriverData.o factory-hardware-emulator/hardware/modbus/StepMotorDriverData.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/StepMotorDriverDataInput.o: factory-hardware-emulator/hardware/modbus/StepMotorDriverDataInput.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/StepMotorDriverDataInput.o factory-hardware-emulator/hardware/modbus/StepMotorDriverDataInput.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/SystemLogReport.o: factory-hardware-emulator/hardware/modbus/SystemLogReport.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/SystemLogReport.o factory-hardware-emulator/hardware/modbus/SystemLogReport.cpp
...
${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/_group_modbus.o: factory-hardware-emulator/hardware/modbus/_group_modbus.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/hardware/modbus/_group_modbus.o factory-hardware-emulator/hardware/modbus/_group_modbus.cpp
...
${OBJECTDIR}/factory-hardware-emulator/network/ModbusNetworkController.o: factory-hardware-emulator/network/ModbusNetworkController.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/network/ModbusNetworkController.o factory-hardware-emulator/network/ModbusNetworkController.cpp

${OBJECTDIR}/factory-hardware-emulator/network/NetworkClock.o: factory-hardware-emulator/network/NetworkClock.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/network/NetworkClock.o factory-hardware-emulator/network/NetworkClock.cpp

${OBJECTDIR}/factory-hardware-emulator/network/_group_network.o: factory-hardware-emulator/network/_group_network.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/network
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/network/_group_network.o factory-hardware-emulator/network/_group_network.cpp
...
${OBJECTDIR}/factory-hardware-emulator/network/scheduled/ScheduledCommandRequest.o: factory-hardware-emulator/network/scheduled/ScheduledCommandRequest.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/network/scheduled/ScheduledCommandRequest.o factory-hardware-emulator/network/scheduled/ScheduledCommandRequest.cpp
...
${OBJECTDIR}/factory-hardware-emulator/network/scheduled/ScheduledCommandResult.o: factory-hardware-emulator/network/scheduled/ScheduledCommandResult.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/network/scheduled
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/network/scheduled/ScheduledCommandResult.o factory-hardware-emulator/network/scheduled/ScheduledCommandResult.cpp
...
${OBJECTDIR}/factory-hardware-emulator/network/scheduled/ScheduledDeviceCommandQueue.o: factory-hardware-emulator/network/scheduled/ScheduledDeviceCommandQueue.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/network/scheduled
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/network/scheduled/ScheduledDeviceCommandQueue.o factory-hardware-emulator/network/scheduled/ScheduledDeviceCommandQueue.cpp
...
${OBJECTDIR}/factory-hardware-emulator/network/scheduled/_group_scheduled.o: factory-hardware-emulator/network/scheduled/_group_scheduled.cpp 
	${MKDIR} -p ${OBJECTDIR}/factory-hardware-emulator/network/scheduled
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/network/scheduled/_group_scheduled.o factory-hardware-emulator/network/scheduled/_group_scheduled.cpp
...
${OBJECTDIR}/factory-hardware-emulator/system/_group_system.o: factory-hardware-emulator/system/_group_system.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++14 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/factory-hardware-emulator/system/_group_system.o factory-hardware-emulator/system/_group_system.cpp
